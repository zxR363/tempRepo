...
def main():
    ...
    # creating processes
    p1 = multiprocessing.Process(target=createVideoPlayer, args=(1, "C:\\Users\\democh\\Desktop\\2.mp4",30000,))
    p2 = multiprocessing.Process(target=createVideoPlayer, args=(2, "C:\\Users\\democh\\Desktop\\2.mp4",30000,))
